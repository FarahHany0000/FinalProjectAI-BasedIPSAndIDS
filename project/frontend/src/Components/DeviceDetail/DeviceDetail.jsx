              ...
              <tbody>
                {alerts.length > 0 ? alerts.slice(0, 50).map((alert, i) => (
                  <tr key={i}>
                    ...
                    <td>
                      <span className={`status-badge ${alert.prediction === "Normal" || alert.prediction === "Benign" ? "benign" : "malicious"}`}>
                  ...
                  <tr><td colSpan="5" className="empty-logs">No alerts for this device</td></tr>
                )}
              </tbody>
            </table>
          </div>
